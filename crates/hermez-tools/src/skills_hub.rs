...
pub fn handle_skill_search(args: Value) -> Result<String, hermez_core::HermezError> {
...
pub fn handle_skill_fetch(args: Value) -> Result<String, hermez_core::HermezError> {
...
pub fn handle_skill_install(args: Value) -> Result<String, hermez_core::HermezError> {
    let identifier = args.get("identifier")
        .and_then(Value::as_str)
        .ok_or_else(|| {
            hermez_core::HermezError::new(
...
pub fn handle_skill_uninstall(args: Value) -> Result<String, hermez_core::HermezError> {
...
pub fn handle_skill_update_check(args: Value) -> Result<String, hermez_core::HermezError> {
...
pub fn handle_skill_taps(args: Value) -> Result<String, hermez_core::HermezError> {
...
pub fn handle_skill_installed_list(_args: Value) -> Result<String, hermez_core::HermezError> {
    let lock = HubLockFile::load();
...
mod tests {
    ...
    fn test_parse_frontmatter_value() {
        ...
        assert!(val["metadata"]["hermez"]["key"].is_string());
    }
