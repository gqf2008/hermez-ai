...
async fn call_vision_llm(
    ...
    use hermez_llm::auxiliary_client::{call_auxiliary, AuxiliaryRequest, AuxiliaryResponse};
...
pub fn handle_vision_analyze(args: Value) -> Result<String, hermez_core::HermezError> {
    let image_url = args
        .get("image_url")
