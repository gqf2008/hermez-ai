...
impl DiscordAdapter {
    ...
    async fn download_attachment(&self, url: &str, file_name: &str) -> Result<String, String> {
        ...
        let cache_dir = hermez_core::get_hermez_home().join("discord").join("media");
    ...
    async fn register_slash_commands(&self) -> Result<(), String> {
        ...
        let commands = serde_json::json!([
            ...
            { "name": "reset", "description": "Reset your Hermez session", "type": 1 },
            { "name": "status", "description": "Show Hermez session status", "type": 1 },
            { "name": "stop", "description": "Stop the running Hermez agent", "type": 1 },
