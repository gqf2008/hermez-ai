...
//! - `Environment` trait ≈ `HermesAgentBaseEnv`
//! - `AgentResult` ≈ Python `AgentResult` dataclass
//! - `ToolError` ≈ Python `ToolError` dataclass
//! - `AgentLoopConfig` ≈ relevant subset of `HermesAgentEnvConfig`
...
///
/// Mirrors relevant fields of Python `HermesAgentEnvConfig`.
#[derive(Debug, Clone, Serialize, Deserialize)]
...
/// Core environment trait, mirroring Python's `HermesAgentBaseEnv`.
///
