...
pub fn handle_mcp_client(args: Value) -> Result<String, hermes_core::HermesError> {
    let action = args
        .get("action")
...
fn mcp_list_servers() -> Result<String, hermes_core::HermesError> {
...
fn mcp_connect(args: &Value) -> Result<String, hermes_core::HermesError> {
...
fn mcp_disconnect(args: &Value) -> Result<String, hermes_core::HermesError> {
...
fn mcp_list_tools(args: &Value) -> Result<String, hermes_core::HermesError> {
    let server = match args.get("server").and_then(Value::as_str) {
        Some(s) => s.to_string(),
...
fn mcp_call_tool(args: &Value) -> Result<String, hermes_core::HermesError> {
    let server = match args.get("server").and_then(Value::as_str) {
        Some(s) => s.to_string(),
