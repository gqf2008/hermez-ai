...
pub struct PlatformInfo {
    ...
    /// Default toolset name for this platform (e.g. "hermes-telegram").
...
mod tests {
    ...
    fn test_platform_toolset_known() {
        assert_eq!(platform_toolset("cli", ""), "hermes-cli");
        assert_eq!(platform_toolset("telegram", ""), "hermes-telegram");
    }
