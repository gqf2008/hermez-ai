//! Constants and defaults shared across the Hermez system.
//!
...
pub const DEFAULT_AGENT_IDENTITY: &str =
    "You are Hermez Agent, created by Nous Research. You are a helpful \
...
mod tests {
    ...
    fn test_default_agent_identity_non_empty() {
        ...
        assert!(DEFAULT_AGENT_IDENTITY.contains("Hermez Agent"));
    }
