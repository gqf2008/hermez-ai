...
4. Name the token (e.g., "Hermez Agent"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `~/.hermez/.env`:
...
```bash
CANVAS="python $HERMEZ_HOME/skills/productivity/canvas/scripts/canvas_api.py"
